...
//      });
   ...
   private void initialize() {
      ...
      Color c = new Color(238,238,238);//배경색
      ...
      btnNewButton_1_1.setBackground(c);
      ...
      btnNewButton_1_1_1.setBackground(c);
      ...
      btnNewButton_1_1_1_1.setBackground(c);
      ...
      btnNewButton_1_1_1_1_1.setBackground(c);
      btnNewButton_1_1_1_1_1.addActionListener(new ActionListener() {
         public void actionPerformed(ActionEvent e) {
        	 ...
        	 String k = textField.getText()+"( "+hour +":"+minute+" )";
           //textArea.append(getText + "\n");
...
//      frame.getContentPane().add(lblNewLabel);
      ...
      // 다크모드
      JButton btnNewButton_Dark = new JButton("다크모드");
      btnNewButton.setBackground(c);
      btnNewButton_Dark.addActionListener(new ActionListener() {
         public void actionPerformed(ActionEvent e) {
        	 
        	 Color c = new Color(238,238,238);//배경색
        	 if(frame.getContentPane().getBackground()==c) {
      ...
      btnNewButton_Dark.setBounds(420, 13, 116, 50);
      frame.getContentPane().add(btnNewButton_Dark);
